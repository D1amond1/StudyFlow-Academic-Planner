...
import com.example.studyflow.ui.screens.DetailedEvent
import com.example.studyflow.ui.screens.NewNote
import com.example.studyflow.ui.screens.EventCalendar
import com.example.studyflow.ui.screens.EventList
import com.example.studyflow.ui.screens.EventStatus
import com.example.studyflow.ui.screens.Notes
                            ...
                            composable(Screen.EventList.route) {
                                val dummyEventsList = listOf(
                                    DetailedEvent(
                                        1,
                                        "Сдать лабу по ADS",
                                        "Нужно дописать алгоритм красно-черного дерева и залить на GitHub.",
                                        EventStatus.FAILED,
                                        "2h 00m",
                                        120
                                    ),
                                    DetailedEvent(
                                        2,
                                        "Подготовка к экзамену БД",
                                        "Повторить нормальные формы и B+ деревья.",
                                        EventStatus.DONE,
                                        "2d 23h",
                                        4300
                                    ),
                                    DetailedEvent(
                                        3,
                                        "Созвон с командой",
                                        "Обсудить макеты в Figma и структуру базы данных.",
                                        EventStatus.PENDING,
                                        "1m 30s",
                                        90
                                    )
